...
const file_hello_grpc_proto_rawDesc = "" +
	...
	"\fHelloService\x12A\n" +
	"\bSayHello\x12\x18.hello_grpc.HelloRequest\x1a\x19.hello_grpc.HelloResponse\"\x00B\x0fZ\r./;hello_grpcb\x06proto3"

var (
	file_hello_grpc_proto_rawDescOnce sync.Once
	file_hello_grpc_proto_rawDescData []byte
)

func file_hello_grpc_proto_rawDescGZIP() []byte {
	file_hello_grpc_proto_rawDescOnce.Do(func() {
		file_hello_grpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_hello_grpc_proto_rawDesc), len(file_hello_grpc_proto_rawDesc)))
	})
...
func file_hello_grpc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_hello_grpc_proto_rawDesc), len(file_hello_grpc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
